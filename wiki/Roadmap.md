...
~~14. [[Status Badges]]~~ **Shipped 2026-07-15** as the Threat Actors profile's "Status" section — config-driven badges (BOLO, deceased, incarcerated...) rendered on the main canvas and the profile radial preview. Sandbox SVG rendering deliberately deferred as a fast-follow, not blocking.
